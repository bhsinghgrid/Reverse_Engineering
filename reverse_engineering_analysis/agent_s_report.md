...
![Agent-S Class Hierarchy](/Users/bhsingh/.gemini/antigravity/brain/fcf66538-b86a-4c9a-b473-ff03d0b63755/classes.svg)
...
![Agent-S Package Dependencies](/Users/bhsingh/.gemini/antigravity/brain/fcf66538-b86a-4c9a-b473-ff03d0b63755/packages.svg)
...
![Agent-S Call Graph](/Users/bhsingh/.gemini/antigravity/brain/fcf66538-b86a-4c9a-b473-ff03d0b63755/agent_s_calls.svg)
...
|---|---|---|---|
| **Q1** | Why is the dual-model approach critical? | *Differential analysis* + *Call graph tracing* | [→ Q1](Q1_dual_model_approach.md) |
| **Q2** | Why does ACI remove inactive apps from the AX tree? | *Data flow analysis* + *Pattern search* | [→ Q2](Q2_inactive_apps_filtering.md) |
| **Q3** | Why is episodic memory limited to Turn 0? | *Control flow analysis* + *Assertion tracing* | [→ Q3](Q3_episodic_memory_turn0.md) |
| **Q4** | Why does full context fail despite large windows? | *Static code inspection* + *Runtime log analysis* | [→ Q4](Q4_context_failure.md) |
| **Q5** | How does the Manager-Worker DAG decompose tasks? | *Class hierarchy inspection* + *Algorithm tracing* | [→ Q5](Q5_hierarchical_planning.md) |
| **Q6** | Why does reflection improve success without changing behavior? | *Dependency graph reconstruction* | [→ Q6](Q6_reflection_layer.md) |
| **Q7** | How does `future_tasks`/`done_task` coordinate subtasks? | *Data flow tracing* + *Template analysis* | [→ Q7](Q7_future_done_tasks.md) |
| **Q8** | Why does cost tracking inform behavior beyond monitoring? | *Comparative analysis* S2 vs S3 docstrings | [→ Q8](Q8_cost_tracking.md) |
| **Q9** | How does the `wait` fallback prevent catastrophic failures? | *Exception path analysis* + *Entry point mapping* | [→ Q9](Q9_fallback_mechanism.md) |
| **Q10** | Why use both procedural AND episodic memory? | *Class hierarchy inspection* + *Import analysis* | [→ Q10](Q10_dual_memory.md) |
...
- **Bootstrapper Logic**: [cli_app.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/cli_app.txt)
...
![Agent-S Entry Point Dependencies](/Users/bhsingh/.gemini/antigravity/brain/fcf66538-b86a-4c9a-b473-ff03d0b63755/agent_s_deps.svg)

- **Console Script Definitions**: [entry_points.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/entry_points.txt)
...
- **Prompt Construction Engine**: [memory_module.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/memory_module.txt)
- **Worker Reasoning Logic**: [worker_prompt.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/worker_prompt.txt)
- **Role System Prompts**: [role_prompts.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/role_prompts.txt)
- **Complex Instruction Snippets**: [multiline_prompts.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/multiline_prompts.txt)
...
- **ACI Primitives (Click/Type/Scroll)**: [grounding_prompt.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/grounding_prompt.txt) and [grounding_action.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/grounding_action.txt)
- **Fault Tolerance (`wait` invariant)**: [grounding_fallback.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/grounding_fallback.txt)

### 4.4 Advanced Capabilities: Code Execution
For data-heavy tasks, the agent delegates to its specialized Python/Bash sandbox.
- **Sandbox Guidelines & Guidelines**: [code_prompt.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/code_prompt.txt)
- **System Function Mapping**: [funcs.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/funcs.txt)
- **Dependency Mapping**: [file_map.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/file_map.txt)

### 4.5 Monitoring & Quality Control
Verification and cost tracking are integrated into the core feedback loop.
- **Comparative Judge Prompts**: [judge_prompt.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/judge_prompt.txt)
- **LLM Call Telemetry**: [llm_calls.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/llm_calls.txt)
- **Cost Metrics**: [cost.txt](file:///Users/bhsingh/Documents/Project4/agent_s_analysis/Agent-S/cost.txt)
...
---
Note : *`I do only Static Analysis`*
